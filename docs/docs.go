...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_adapters_driving_http.FailedDocumentsResponse"
                        }
                    },
                    "400": {
    ...
    "definitions": {
        ...
        "github_com_sercha-oss_sercha-core_internal_core_domain.CapabilityDescriptor": {
            "type": "object",
            "properties": {
                "backend_id": {
                    "description": "BackendID is an optional tag identifying the implementation backend\n(e.g. \"opensearch\", \"pgvector\", \"llm\"). Used purely for UX\n(grouping, badges); the capability resolution path does not consult\nit. Empty when the capability has no specific backend.",
                    "type": "string"
                },
                "default_enabled": {
                    "description": "DefaultEnabled is the toggle's default value when no per-team\npreference exists. The resolver uses this as the initial enabled\nstate before applying stored preferences.",
                    "type": "boolean"
                },
                "depends_on": {
                    "description": "DependsOn lists other capability types that must be enabled and\navailable for this capability to function. The resolver cascades\ndisable: if any dependency is not active, this capability is\nmarked disabled.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_sercha-oss_sercha-core_internal_core_domain.CapabilityType"
                    }
                },
                "description": {
                    "description": "Description is one-line guidance text rendered alongside the toggle.",
                    "type": "string"
                },
                "display_name": {
                    "description": "DisplayName is the human-readable label rendered in the admin UI.",
                    "type": "string"
                },
                "grants": {
                ...
                "phase": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/github_com_sercha-oss_sercha-core_internal_core_domain.PipelinePhase"
                        }
                    ]
                },
                "type": {
                    "description": "Type is the unique string key. Must match the registry's view.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/github_com_sercha-oss_sercha-core_internal_core_domain.CapabilityType"
                        }
        ...
        "github_com_sercha-oss_sercha-core_internal_core_domain.CapabilityType": {
            "type": "string",
            "enum": [
                "text_indexing",
                "embedding_indexing",
            ...
            "x-enum-comments": {
                "CapabilityBM25Search": "Keyword search",
                "CapabilityEmbeddingIndexing": "Enables vector search",
                "CapabilityQueryExpansion": "Expands queries with related terms",
                "CapabilityQueryRewriting": "Reformulates queries for better matching",
                "CapabilitySummarization": "Generates result snippets",
                "CapabilityTextIndexing": "Enables BM25 search",
                "CapabilityVectorSearch": "Semantic search"
            },
            "x-enum-descriptions": [
                "Enables BM25 search",
                ...
                "Generates result snippets"
            ],
            "x-enum-varnames": [
                "CapabilityTextIndexing",
                "CapabilityEmbeddingIndexing",
                "CapabilityBM25Search",
                "CapabilityVectorSearch",
        ...
        "github_com_sercha-oss_sercha-core_internal_core_domain.ConnectionSummary": {
            ...
            "properties": {
                ...
                "platform": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/github_com_sercha-oss_sercha-core_internal_core_domain.PlatformType"
                        }
                    ]
                },
                "provider_type": {
        ...
        "github_com_sercha-oss_sercha-core_internal_core_domain.PipelinePhase": {
            "type": "string",
            "enum": [
                "indexing",
                "search"
        ...
        "github_com_sercha-oss_sercha-core_internal_core_domain.PlatformType": {
            "type": "string",
            "enum": [
                "github",
                "localfs",
        ...
        "github_com_sercha-oss_sercha-core_internal_core_domain.SyncExclusionSettings": {
            ...
            "properties": {
                ...
                "mime_exclusions": {
                    "description": "MimeExclusions are MIME type patterns to exclude (e.g., \"image/*\", \"font/*\")",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "github_com_sercha-oss_sercha-core_internal_core_domain.SyncFailedDoc": {
            "type": "object",
            "properties": {
                "attempt_count": {
                    "description": "AttemptCount is the number of times we've tried this doc since the\nrow was created. Drives backoff and the terminal cutoff.",
                    "type": "integer"
                },
                "created_at": {
                    "description": "CreatedAt is when the first failure for this (source_id,\nexternal_id) was recorded.",
                    "type": "string"
                },
                "external_id": {
                    "description": "ExternalID is the connector's identifier for the doc that failed.\nNot the Sercha-internal document_id: failures often happen before\nany internal row gets created.",
                    "type": "string"
                },
                "last_attempted_at": {
                    "description": "LastAttemptedAt is when the most recent attempt ran. Useful for\n\"stuck since X\" presentations in admin UIs.",
                    "type": "string"
                },
                "last_error": {
                    "description": "LastError is the error message from the most recent attempt,\ntruncated by the store layer for storage hygiene.",
                    "type": "string"
                },
                "next_retry_after": {
                    "description": "NextRetryAfter is the earliest time the orchestrator should retry\nthis doc. The retry pre-pass picks rows where\nnext_retry_after \u003c= now() AND terminal = false.",
                    "type": "string"
                },
                "source_id": {
                    "description": "SourceID is the parent source — the (source_id, external_id) pair\nis the primary key.",
                    "type": "string"
                },
                "terminal": {
                    "description": "Terminal is true once the row has exceeded the configured maximum\nattempt count. Excluded from automatic retry; remains in the table\nfor operator visibility.",
                    "type": "boolean"
                }
            }
        },
        ...
        "github_com_sercha-oss_sercha-core_internal_core_ports_driven.Container": {
            ...
            "properties": {
                ...
                "has_children": {
                    "description": "HasChildren indicates if this container has child containers (for folder navigation).",
                    "type": "boolean"
                },
                "id": {
        ...
        "github_com_sercha-oss_sercha-core_internal_core_ports_driving.CapabilitiesResponse": {
            ...
            "properties": {
                ...
                "descriptors": {
                    "description": "Descriptors lists every registered capability's metadata. Drives\ndynamic UI rendering — the admin panel iterates this list to know\nwhat toggles to show.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_sercha-oss_sercha-core_internal_core_domain.CapabilityDescriptor"
                    }
                },
                "features": {
                    "description": "Features maps each registered capability's type to its resolved\nruntime status (available + enabled + active). Stable counterpart\nto Descriptors: callers cross-reference by Type.",
                    "type": "object",
                    "additionalProperties": {
                ...
                "oauth_providers": {
                    "description": "OAuthProviders lists OAuth platforms configured via environment.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_sercha-oss_sercha-core_internal_core_domain.PlatformType"
                    }
        ...
        "github_com_sercha-oss_sercha-core_internal_core_ports_driving.CapabilityStatus": {
            ...
            "properties": {
                "active": {
                    "description": "Active is Available AND Enabled.",
                    "type": "boolean"
                },
                "available": {
                    "description": "Available reports whether the runtime can support this capability\nright now (backends configured, services healthy).",
                    "type": "boolean"
                },
                "enabled": {
                    "description": "Enabled reports the operator's preference (or the descriptor default\nwhen no explicit preference is stored).",
                    "type": "boolean"
                }
            }
        },
        ...
        "internal_adapters_driving_http.FailedDocumentsResponse": {
            ...
            "properties": {
                "documents": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_sercha-oss_sercha-core_internal_core_domain.SyncFailedDoc"
                    }
                },
                "total": {
                    "type": "integer"
