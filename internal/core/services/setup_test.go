...
func newTestSetupService() (*mocks.MockUserStore, *mocks.MockSourceStore, *setupService) {
	userStore := mocks.NewMockUserStore()
	sourceStore := mocks.NewMockSourceStore()
	svc := NewSetupService(userStore, sourceStore, "team-123").(*setupService)
	return userStore, sourceStore, svc
}

func TestSetupService_GetStatus_SetupIncomplete_NoUsers(t *testing.T) {
	_, sourceStore, svc := newTestSetupService()
...
func TestSetupService_GetStatus_SetupIncomplete_NoSources(t *testing.T) {
	userStore, _, svc := newTestSetupService()
...
func TestSetupService_GetStatus_SetupComplete(t *testing.T) {
	userStore, sourceStore, svc := newTestSetupService()
